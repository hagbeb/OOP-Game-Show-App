...
// create variable to hold Game object
let currentGame = null;
start.addEventListener('click', (e) => {
    // start the game if there isn't one already
    if (!currentGame) {
...
keyArea.addEventListener('click', (e) => {
    // if there is a current game, and it was a key clicked/pressed, ...
    // ... call handleInteraction, passing in the relevant letter
    if (currentGame && e.target.tagName === 'BUTTON') {
...
document.addEventListener('keyup', (e) => {
    ...
    // if there is a current game, and a key was clicked
    if(currentGame && reg) {
